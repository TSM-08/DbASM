...
CREATE INDEX IF NOT EXISTS idx_validation_15_child_parent ON trg.validation_15 (child_table, parent_table, join_condition);
CREATE INDEX IF NOT EXISTS idx_validation_15_child_parent ON src.validation_15 (child_table, parent_table, join_condition);