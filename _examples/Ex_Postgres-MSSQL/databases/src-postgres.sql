-- PostgreSQL database schema and sample data (Source)
-- =====================================================================
-- CREATE DATABASE
-- =====================================================================
CREATE DATABASE purchase_s;
...
CREATE INDEX ix_po_supplier
    ON purchase.purchase_orders (supplier_id);

CREATE INDEX ix_po_client
    ON purchase.purchase_orders (client_id);

CREATE INDEX ix_poi_po
    ON purchase.purchase_order_items (po_id);

CREATE INDEX ix_poi_product
    ON purchase.purchase_order_items (product_id);
...
(1, 1, '2026-04-01', 'Pending',    500.00, 'Y', '2026-04-21 16:34:12.849'),
(2, 2, '2026-04-02', 'Approved',   820.00, 'Y', '2026-04-21 16:34:12.849'),
(1, 3, '2026-04-03', 'Delivered', 1550.00, 'N', '2026-04-21 16:34:12.849'),
(3, 1, '2026-04-04', 'Pending',    230.00, 'Y', '2026-04-21 16:34:12.849'),
(2, 1, '2026-04-05', 'Delivered',  920.00, 'N', '2026-04-21 16:34:12.849'),
(1, 2, '2026-04-06', 'Approved',  1340.00, 'Y', '2026-04-21 16:34:12.849'),
(3, 3, '2026-04-07', 'Pending',    120.00, 'Y', '2026-04-21 16:34:12.849'),
(2, 3, '2026-04-08', 'Cancelled',    0.00, 'N', '2026-04-21 16:34:12.849'),
(1, 1, '2026-04-09', 'Pending',    640.00, 'Y', '2026-04-21 16:34:12.849'),
(3, 2, '2026-04-10', 'Delivered',  310.00, 'N', '2026-04-21 16:34:12.849'),
(1, 3, '2026-04-11', 'Approved',  2550.00, 'Y', '2026-04-21 16:34:12.849'),
(2, 1, '2026-04-12', 'Delivered',  780.00, 'N', '2026-04-21 16:34:12.849'),
(3, 2, '2026-04-13', 'Pending',     95.00, 'Y', '2026-04-21 16:34:12.849'),
(1, 2, '2026-04-14', 'Pending',   1425.00, 'Y', '2026-04-21 16:34:12.849'),
(2, 3, '2026-04-15', 'Delivered',  360.00, 'N', '2026-04-21 16:34:12.849'),
(3, 1, '2026-04-16', 'Approved',  1080.00, 'Y', '2026-04-21 16:34:12.849'),
(1, 1, '2026-04-17', 'Delivered', 1670.00, 'N', '2026-04-21 16:34:12.849'),
(2, 2, '2026-04-18', 'Pending',    240.00, 'Y', '2026-04-21 16:34:12.849'),
(3, 3, '2026-04-19', 'Approved',   560.00, 'Y', '2026-04-21 16:34:12.849'),
(1, 2, '2026-04-20', 'Delivered',  400.00, 'N', '2026-04-21 16:34:12.849'),
(2, 1, '2026-04-21', 'Pending',    890.00, 'Y', '2026-04-21 16:34:12.849'),
(3, 2, '2026-04-22', 'Delivered',  150.00, 'N', '2026-04-21 16:34:12.849'),
(1, 3, '2026-04-23', 'Approved',  2250.00, 'Y', '2026-04-21 16:34:12.849'),
(2, 3, '2026-04-24', 'Approved',   330.00, 'Y', '2026-04-21 16:34:12.849'),
(3, 1, '2026-04-25', 'Delivered',  190.00, 'N', '2026-04-21 16:34:12.849'),
(1, 2, '2026-04-26', 'Pending',   1320.00, 'Y', '2026-04-21 16:34:12.849'),
(2, 1, '2026-04-27', 'Pending',    870.00, 'Y', '2026-04-21 16:34:12.849'),
(3, 3, '2026-04-28', 'Delivered',  260.00, 'N', '2026-04-21 16:34:12.849'),
(1, 1, '2026-04-29', 'Approved',  1560.00, 'Y', '2026-04-21 16:34:12.849'),
(2, 2, '2026-04-30', 'Delivered',  480.00, 'N', '2026-04-21 16:34:12.849');
