...
def get_config_item(config: dict, *keys: str, default: Any = None) -> Any:
    """Utility function to get nested configuration items with a default value."""
    # Example usage:
    # dbs_chunk_rows = get_config_item(config, 'hashing', 'dbs_chunk_rows', default=10000)
    current = config
    for key in keys:
